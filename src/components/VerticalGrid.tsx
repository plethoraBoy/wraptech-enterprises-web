...
const Panel = ({
  ...
  return (
    <>
      <button className="panel-button" onClick={() => setOpen(id)}>
        <span className="panel-title-vertical">{title}</span>
